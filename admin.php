...
<body class="bg-lightgray-1 vh-100">
    ...
    <main>
        <div class="container p-4 mx-auto">
            ...
            <label>Name</label>
            <input class="p-2 my-2 d-block rounded-2 col-5" id="name" type="name" placeholder="Name">

            <label>Password</label><br>
            <input class="p-2 my-2 d-block rounded-2 col-5" id="password" type="password" placeholder="Password">

            <label>Confirm Password</label><br>
            <input class="p-2 my-2 d-block rounded-2 col-5" id="password_confirmation" type="password" placeholder="Confirm Password">

            <button class="btn btn-primary text-uppercase" id="registerBtn" type="submit">Register</button>
